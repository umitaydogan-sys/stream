...
func (m *Manager) LoadDefaults() error {
	...
	defaults := map[string]struct {
		...
		"archive_enabled":                          {"false", "storage"},
		"archive_ui_mode":                          {"simple", "storage"},
		"archive_provider":                         {"local", "storage"},
		"archive_provider_variant":                 {"local", "storage"},
		"archive_local_dir":                        {"", "storage"},
		"archive_endpoint":                         {"", "storage"},
		"archive_region":                           {"us-east-1", "storage"},
		"archive_bucket":                           {"", "storage"},
		"archive_access_key":                       {"", "storage"},
		"archive_secret_key":                       {"", "storage"},
		"archive_rclone_remote":                    {"", "storage"},
		"archive_rclone_path":                      {"", "storage"},
		"archive_rclone_config_path":               {"", "storage"},
		"archive_sftp_host":                        {"", "storage"},
		"archive_sftp_port":                        {"22", "storage"},
		"archive_sftp_user":                        {"", "storage"},
		"archive_sftp_remote_dir":                  {"", "storage"},
		"archive_sftp_key_path":                    {"", "storage"},
		"archive_sftp_disable_host_key_check":      {"false", "storage"},
		"archive_prefix":                           {"fluxstream", "storage"},
		"archive_use_path_style":                   {"true", "storage"},
		"archive_public_base_url":                  {"", "storage"},
		"archive_auto_upload":                      {"false", "storage"},
		"archive_schedule":                         {"immediate", "storage"},
		"archive_target_tier":                      {"standard", "storage"},
		"archive_cold_after_days":                  {"30", "storage"},
		"archive_delete_local_after_upload":        {"false", "storage"},
		"archive_scan_interval_minutes":            {"10", "storage"},
		"archive_batch_size":                       {"3", "storage"},
		"backup_archive_use_same_target":           {"true", "storage"},
		"backup_archive_enabled":                   {"false", "storage"},
		"backup_archive_provider":                  {"local", "storage"},
		"backup_archive_provider_variant":          {"local", "storage"},
		"backup_archive_local_dir":                 {"", "storage"},
		"backup_archive_endpoint":                  {"", "storage"},
		"backup_archive_region":                    {"us-east-1", "storage"},
		"backup_archive_bucket":                    {"", "storage"},
		"backup_archive_access_key":                {"", "storage"},
		"backup_archive_secret_key":                {"", "storage"},
		"backup_archive_rclone_remote":             {"", "storage"},
		"backup_archive_rclone_path":               {"", "storage"},
		"backup_archive_rclone_config_path":        {"", "storage"},
		"backup_archive_sftp_host":                 {"", "storage"},
		"backup_archive_sftp_port":                 {"22", "storage"},
		"backup_archive_sftp_user":                 {"", "storage"},
		"backup_archive_sftp_remote_dir":           {"", "storage"},
		"backup_archive_sftp_key_path":             {"", "storage"},
		"backup_archive_sftp_disable_host_key_check": {"false", "storage"},
		"backup_archive_prefix":                    {"fluxstream", "storage"},
		"backup_archive_use_path_style":            {"true", "storage"},
		"backup_archive_public_base_url":           {"", "storage"},
		"backup_archive_auto_upload":               {"false", "storage"},
		"backup_archive_schedule":                  {"weekly", "storage"},
		"backup_archive_target_tier":               {"cold", "storage"},
		"backup_archive_cold_after_days":           {"7", "storage"},
		"backup_archive_delete_local_after_upload": {"false", "storage"},
		"backup_archive_scan_interval_minutes":     {"30", "storage"},
		"backup_archive_batch_size":                {"2", "storage"},
		...
		"recording_format":    {"mp4", "recording"},
		...
		"alerts_qoe_audio_ratio_threshold":      {"3", "health"},
