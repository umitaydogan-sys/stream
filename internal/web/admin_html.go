...
.form-input,.form-select,.form-textarea{width:100%;padding:12px 16px;background:linear-gradient(180deg,#ffffff 0%,#f7fbff 100%);border:1px solid rgba(148,163,184,.22);border-radius:18px;color:var(--text-primary);font-size:14px;font-family:inherit;transition:border-color .2s, box-shadow .2s, transform .2s;outline:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.92),0 8px 22px rgba(15,23,42,.04)}
.form-input:focus,.form-select:focus,.form-textarea:focus{border-color:rgba(37,99,235,.34);box-shadow:0 0 0 4px rgba(37,99,235,.10),0 14px 28px rgba(37,99,235,.09);transform:translateY(-1px)}
...
.form-textarea{min-height:110px;resize:vertical;border-radius:20px}
